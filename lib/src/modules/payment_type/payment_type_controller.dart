...
abstract class PaymentTypeControllerBase with Store {
  ...
  Future<void> loadPayments() async {
    try {
      ...
      _status = PaymentTypeStateStatus.laoded;
    } catch (e, s) {
      log('Erro ao acrregar as formas de pagammento', error: e, stackTrace: s);
      _status = PaymentTypeStateStatus.error;
      _errorMessage = 'Erro ao acrregar as formas de pagammento';
    }
  }
  ...
  Future<void> savePayment({
    ...
    _status = PaymentTypeStateStatus.loading;
    final PaymentTypeModel paymentTypeModel = PaymentTypeModel(
      id: id,
      name: name,
      acronym: acronym,
      enabled: enabled,
